cmd_/swap/nfs/rootfs/driver/03_newchrled/newchrled.mod.o := arm-linux-gnueabihf-gcc -Wp,-MMD,/swap/nfs/rootfs/driver/03_newchrled/.newchrled.mod.o.d -nostdinc -I./arch/arm/include -I./arch/arm/include/generated -I./include -I./arch/arm/include/uapi -I./arch/arm/include/generated/uapi -I./include/uapi -I./include/generated/uapi -include ./include/linux/compiler-version.h -include ./include/linux/kconfig.h -include ./include/linux/compiler_types.h -D__KERNEL__ -mlittle-endian -D__LINUX_ARM_ARCH__=6 -Wall -Wundef -Werror=strict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -fshort-wchar -fno-PIE -Werror=implicit-function-declaration -Werror=implicit-int -Werror=return-type -Wno-format-security -funsigned-char -std=gnu11 -fno-dwarf2-cfi-asm -fno-ipa-sra -mabi=aapcs-linux -mfpu=vfp -funwind-tables -marm -Wa,-mno-warn-deprecated -march=armv6k -mtune=arm1136j-s -msoft-float -Uarm -fno-delete-null-pointer-checks -O2 --param=allow-store-data-races=0 -Wframe-larger-than=1024 -fstack-protector-strong -Wno-main -Wno-unused-but-set-variable -fomit-frame-pointer -Wdeclaration-after-statement -Wvla -Wno-pointer-sign -Wno-maybe-uninitialized -fno-strict-overflow -fno-stack-check -fconserve-stack -Werror=date-time -Werror=incompatible-pointer-types -Werror=designated-init -DMODULE -DKBUILD_BASENAME='"newchrled.mod"' -DKBUILD_MODNAME='"newchrled"' -D__KBUILD_MODNAME=kmod_newchrled -c -o /swap/nfs/rootfs/driver/03_newchrled/newchrled.mod.o /swap/nfs/rootfs/driver/03_newchrled/newchrled.mod.c

source_/swap/nfs/rootfs/driver/03_newchrled/newchrled.mod.o := /swap/nfs/rootfs/driver/03_newchrled/newchrled.mod.c

deps_/swap/nfs/rootfs/driver/03_newchrled/newchrled.mod.o := \
...
/swap/nfs/rootfs/driver/03_newchrled/newchrled.mod.o: $(deps_/swap/nfs/rootfs/driver/03_newchrled/newchrled.mod.o)
